...
import pymysql
import cgi
connection = pymysql.connect(user='root', password='root', db='store',
...
def delete_product(product_id):
      try:
            ...
            result = {'STATUS': 'ERROR', 'MSG':"Something went wrong when deleting product with id {product_id}",'CODE':500}      
